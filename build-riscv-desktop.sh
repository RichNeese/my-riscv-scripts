...
#bables150 riscv builder
git clone --depth 1 -b risc-v https://github.com/150balbes/build.git

mkdir build/userpatches

cat > build/userpatches/config-desktop.conf << DELIM
...
DESKTOP_APPGROUPS_SELECTED="3dmesa accessabilty app-launcher archivers desktop_tools development disk-tools editors file-share fonts graphice internet multimedia net-tools office pkg-tools printing remote_desktop shells system-info terminals"
DELIM
